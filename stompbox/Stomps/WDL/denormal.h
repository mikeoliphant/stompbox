...
#ifdef WDL_DENORMAL_BYPASS
#error denormal.h: WDL_DENORMAL_BYPASS no longer supported, use WDL_DENORMAL_DO_NOT_FILTER instead
#endif
...
#if (defined(WDL_DENORMAL_FTZ) || defined(WDL_DENORMAL_DAZ)) && (defined(_MSC_VER) || __GNUC__ > 4 || (__GNUC__ == 4 && (__GNUC_MINOR__ > 4 || (__GNUC_MINOR__ == 4 && __GNUC_PATCHLEVEL__ >= 7))))
#pragma message("denormal.h: WDL_DENORMAL_FTZ/DAZ no longer supported")
#endif

#ifdef WDL_DENORMAL_WANTS_SCOPED_FTZ
class WDL_DenormalMode: public WDL_denormal_ftz_scope { public: WDL_DenormalMode(bool ftz = true, bool daz = true): WDL_denormal_ftz_scope() {} };
#endif
